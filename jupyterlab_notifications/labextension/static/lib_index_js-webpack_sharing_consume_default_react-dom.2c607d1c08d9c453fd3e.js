...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, '/api', endPoint);
    let response;
    try {
    ...
    createNew(panel, context) {
        const mybutton = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_5__.ToolbarButton({
            ...
            onClick: async () => {
                ...
                try {
                    const reply = await (0,_handler__WEBPACK_IMPORTED_MODULE_6__.requestAPI)("notifications", {
        ...
        ws.onmessage = async function (rowId) {
            try {
                ...
                if (!ignoreNotifs.has(rowId.data)) {
                    const data = await (0,_handler__WEBPACK_IMPORTED_MODULE_6__.requestAPI)("notifications/" + rowId.data);
                    // console.log(data);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".Card .title {\n  font-size: 23px; }\n", "",{"version":3,"sources":["webpack://./style/main.css"],"names":[],"mappings":"AAAA;EACE,eAAe,EAAE","sourcesContent":[".Card .title {\n  font-size: 23px; }\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_react-dom.2c607d1c08d9c453fd3e.js.map